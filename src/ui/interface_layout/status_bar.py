...
class StatusBar(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.var_tracking = tk.StringVar(value="Tracking: 0 objects")
        ...
        ttk.Label(self, textvariable=self.var_tracking, anchor="center").grid(row=0, column=3)
        ttk.Label(self, textvariable=self.var_fps,   anchor="e").grid(row=0, column=4, sticky="e")
